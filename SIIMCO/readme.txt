The data after pre-processing left remain 47468. According the emails address of employees, we can get a statistics about  the number of emails each employee sends to each other.
